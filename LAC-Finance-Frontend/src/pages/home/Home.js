...
class Home extends Component {
  ...
  loginToDashboard = async (event) => {
    ...
    if (
      ...
      // console.log(
      //   await post("app/login", { username: "Admin", password: "admin123" })
      // );
      await this.getToken();
      sessionStorage.setItem("loggedInUser", this.state.email);
      sessionStorage.setItem("secretToken", this.state.token);
          ...
          <div>
            ...
            <Grid container spacing={0}>
              ...
              <Grid
                ...
                style={{
                  marginTop: 32,
                  marginLeft: mediaQuery ? 0 : 20,
                  marginRight: mediaQuery ? 0 : 20,
                }}
              >
