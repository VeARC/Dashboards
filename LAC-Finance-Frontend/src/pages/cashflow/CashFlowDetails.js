...
import {
    Button, Grid, withStyles, Select, MenuItem, useMediaQuery, FormControl,
    InputLabel
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                { headerName: 'Start Date', field: 'Date', cellStyle: { 'text-align': "center" } },
                { headerName: 'Investment Cost', field: 'InvestmentCost', cellStyle: { 'text-align': "center" } },
                { headerName: 'Estimated Value', field: 'InvEstimatedValue', cellStyle: { 'text-align': "center" } },
                    ...
                    <div>
                        ...
                        <Grid container spacing={0}>
                            ...
                            <Grid item xs={9} style={{margin: 'auto'}}>
                                <Button className={classes.customButtonPrimary} variant="contained" style={{float: 'right'}}
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item>
                                <Button fullWidth className={classes.customButtonSecondary} variant="contained"
                                    color="primary" onClick={this.clearSearchInput} size="medium">
                                    Clear
                                </Button>
                            </Grid>
                            <Grid item>
                        ...
                        <Grid container spacing={0}>
                            <Grid item xs={12}>
                                <div className="ag-theme-alpine" style={{ width: "100%", height: 450, marginTop: 20 }}>
                                    <AgGridReact
